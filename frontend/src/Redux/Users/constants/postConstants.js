...
export const GET_PINNED_POSTS_REQUEST = "GET_PINNED_POSTS_REQUEST";
export const GET_PINNED_POSTS_SUCCESS = "GET_PINNED_POSTS_SUCCESS";
export const GET_PINNED_POSTS_FAIL = "GET_PINNED_POSTS_FAIL";
